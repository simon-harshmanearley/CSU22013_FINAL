...
```{r}
# Graph 1: Languages Stacked Barplot
...
```{r}
# Graph 2: Developer commit count barplot grouped by repo
...
```{r}
# Graph 3: Data Table of developer names, repos and emails
# Input: commits_count
...
main <- function(date_range,language){
      ...
      dropdown_list <- get_list_of_languages(language_df)
      ...
      # Draw graphs
      stackedLanguageBarplot = graph_languages(language_df)
      groupedCommitsBarplot = graph_commits(commits_count)
      dev_info_table <- create_dev_info_table(commits_count)
}
```
