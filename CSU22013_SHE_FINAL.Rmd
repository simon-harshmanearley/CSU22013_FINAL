...
languageDataFrame <- create_language_dataframe('daily', 10)
...
```{r}
create_top_5_language_dataframe <- function(language_choice) {
...
user_language_choice <- "Python"

# Call the function with the user's language choice
top_repositories_for_language <- create_top_5_language_dataframe(user_language_choice)
top_repositories_for_language
```
