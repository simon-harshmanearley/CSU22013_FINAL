...
total_day_commits_24hours_list <- list()
total_night_commits_24hours_list <- list()

total_commits_since_last_7_days_list <- list()
total_day_commits_last_7_days_list <- list()
total_night_commits_last_7_days_list <- list()

total_commits_since_last_month_list <- list()
total_day_commits_since_last_month_list <- list()
total__night_commits_since_last_month_list <- list()

total_commits_since_last_6_months_list <- list()
total_day_commits_since_last_6_months_list <- list()
total_night_commits_since_last_6_months_list <- list()

total_commits_since_last_year_list <- list()
total_day_commits_since_last_year_list <- list()
total_night_commits_since_last_year_list <- list()



# TOTAL commit functions
# Function to fetch total commits for all time
...
# Function to fetch total commits for all time after 8am but before 6pm
...
# Function to fetch total commits for all time after 6pm but before 8am
...
# 24 HOUR commit functions
# Function to fetch total commits from last 24 hours 
...
# Function to fetch total commits from last 24 hours after 8am but before 6pm
fetch_total_day_commits_24hours <- function(commit_activity_url) {
  # Set page number to 1, and total commit count to 0
  page <- 1
  total_day_commits <- 0
  ...
  while (TRUE) {
    ...
    # Access the commit data from specified page of URL using official GitHub API
    response <- GET(commits_url, add_headers(headers),       query = list(since = since_24_hours_iso,
                   until = now_iso))
    commit_data <- content(response)
...
# Function to fetch total commits from last 24 hours after 6pm but before 8am
fetch_total_night_commits_24hours <- function(commit_activity_url) {
  # Set page number to 1, and total commit count to 0
  page <- 1
  total_night_commits <- 0
...
# LAST 7 DAYS commit functions
# Function to fetch total commits from last 7 days
...
# Function to fetch total commits from last 7 days after 8am but before 6pm
fetch_total_day_commits_last_7_days <- function(commit_activity_url) {
  # Set page number to 1, and total commit count to 0
  page <- 1
  total_day_commits <- 0
...
# Function to fetch total commits from last 7 days after 6pm but before 8am
fetch_total_night_commits_last_7_days <- function(commit_activity_url) {
  # Set page number to 1, and total commit count to 0
  page <- 1
  total_night_commits <- 0
  ...
  while (TRUE) {
    ...
    # Access the commit data from specified page of URL using official GitHub API
    response <- GET(commits_url, add_headers(headers), query = list(since = since_last_7_days_iso,
                   until = now_iso))
    commit_data <- content(response)
...
# LAST MONTH commit functions
# Function to fetch total commits from last month 
...
# Function to fetch total commits from last month after 8am but before 6pm
fetch_total_day_commits_last_month <- function(commit_activity_url) {
  # Set page number to 1, and total commit count to 0
  page <- 1
  total_day_commits <- 0
...
# Function to fetch total commits from last month after 6pm but before 8am
fetch_total_night_commits_last_month <- function(commit_activity_url) {
  # Set page number to 1, and total commit count to 0
  page <- 1
  total_night_commits <- 0
  ...
  while (TRUE) {
    ...
    # Access the commit data from specified page of URL using official GitHub API
    response <- GET(commits_url, add_headers(headers), query = list(since = since_last_month_iso,
                   until = now_iso))
    commit_data <- content(response)
...
# LAST 6 MONTHS commit functions
# Function to fetch total commits from last 6 months 
...
# Function to fetch total commits from last 6 months after 8am but before 6pm
fetch_total_day_commits_last_6_months <- function(commit_activity_url) {
  # Set page number to 1, and total commit count to 0
  page <- 1
  total_day_commits <- 0
...
# Function to fetch total commits from last 6 months after 6pm but before 8am
fetch_total_night_commits_last_6_months <- function(commit_activity_url) {
  # Set page number to 1, and total commit count to 0
  page <- 1
  total_night_commits <- 0
  ...
  while (TRUE) {
    ...
    # Access the commit data from specified page of URL using official GitHub API
    response <- GET(commits_url, add_headers(headers), query = list(since = since_last_6_months_iso,
                   until = now_iso))
    commit_data <- content(response)
...
# LAST YEAR commit functions
# Function to fetch total commits from last year 
...
# Function to fetch total commits from last year after 8am but before 6pm
fetch_total_day_commits_last_year <- function(commit_activity_url) {
  # Set page number to 1, and total commit count to 0
  page <- 1
  total_day_commits <- 0
...
# Function to fetch total commits from last year after 6pm but before 8am
fetch_total_night_commits_last_year <- function(commit_activity_url) {
  # Set page number to 1, and total commit count to 0
  page <- 1
  total_night_commits <- 0
  ...
  while (TRUE) {
    ...
    # Access the commit data from specified page of URL using official GitHub API
    response <- GET(commits_url, add_headers(headers), query = list(since = since_last_year_iso,
                   until = now_iso))
    commit_data <- content(response)
